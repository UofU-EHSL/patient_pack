...
public class patient_line_renderer : MonoBehaviour
{
    ...
    public float val;
    public int time;
    // Ben added this to include audio
    [Header("Audio settings")]
    public bool MaxPlayAudio;
    public float MaxSoundValue;
    public AudioSource MaxAudio;
    private bool beep;
    [Header("Flat line audio")]
    public bool MinPlayAudio;
    ...
    public void AddPoint(float t, float val)
    {
        ...
        //Ben Engel added
        if (MaxPlayAudio == true)
        {
            if (val >= MaxSoundValue && beep == true)
            {
                beep = false;
                MaxAudio.Play();
                rate++;
            }
            else if (val <= MaxSoundValue)
            {
                beep = true;
            }
        }
